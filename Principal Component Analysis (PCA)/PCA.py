# -*- coding: utf-8 -*-
"""
Created on Sat Nov 18 11:22:42 2017
...
pca=PCA(n_components = None) # we use none to find out the variance for each and every IDV
X_train=pca.fit_transform(X_train)
X_test=pca.fit_transform(X_test)
explained_variance=pca.explained_variance_ratio_


# Now we know top two variance IDVs that explains DV the most we will replace none by 2
# Applying PCA
from sklearn.decomposition import PCA
...
# Predicting the new Results with Train set data
